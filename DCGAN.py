...
class DCGAN:
    ...
    def d_train_step(self, batch_size, latent_dim, real_img):
        fake_label = tf.ones((self.batch_size, 1),tf.float32)       #反轉標籤
    ...
    def train(self, epochs=500, sample_interval=10):
        ...
        for epoch in range(epochs):
            ...
            if (epoch % sample_interval == 0) or (epoch + 1 == epochs):
                ...
                self.generator.save_weights('C:/Users/Pomelo Chen/Desktop/Python/GANpy/GAN_weights/dcgan_g_{}'.format(epoch))
                self.discriminator.save_weights('C:/Users/Pomelo Chen/Desktop/Python/wgan/dcgan_d_{}'.format(epoch))
    ...
    def sample_images(self, epoch):
        ...
        fig.savefig('C:/Users/Pomelo Chen/Desktop/Python/GANpy/DCGAN_pic/%d.png' % (epoch+1))
        plt.close()

dcgan = DCGAN()
dcgan.generator.summary()
dcgan.discriminator.summary()
tr_L_G_avg, tr_L_D_avg = dcgan.train(epochs=30, sample_interval=1)
