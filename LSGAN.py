...
class DCGAN:
    ...
    def g_train_step(self, batch_size, latent_dim):
        ...
        with tf.GradientTape() as tape:
            ...
            mse_g = MeanSquaredError()
            loss_g = mse_g(real_label, pred_fake)
    ...
    def d_train_step(self, batch_size, latent_dim, real_img):
        real_label = tf.ones((self.batch_size, 1),tf.float32)
        fake_label = 0 * tf.ones((self.batch_size, 1),tf.float32)
        ...
        with tf.GradientTape() as tape:
            ...
            mse_d = MeanSquaredError()
            loss_d = mse_d(label,pred)
    ...
    def train(self, epochs=40, sample_interval=1):
        ...
        for epoch in range(epochs):
            ...
            if (epoch % sample_interval == 0) or (epoch + 1 == epochs):
                ...
                self.generator.save_weights('C:/Users/Pomelo Chen/Desktop/Python/GANpy/GAN_weights/lsgan_g_{}'.format(epoch+1))
                self.discriminator.save_weights('C:/Users/Pomelo Chen/Desktop/Python/GANpy/GAN_weights/lsgan_d_{}'.format(epoch+1))
    ...
    def sample_images(self, epoch):
        ...
        fig.savefig('C:/Users/Pomelo Chen/Desktop/Python/GANpy/LSGAN_pic/%d.png' % (epoch+1))
        plt.close()

dcgan = DCGAN()
dcgan.generator.summary()
dcgan.discriminator.summary()
tr_L_G_avg, tr_L_D_avg = dcgan.train()
